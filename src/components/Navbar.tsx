      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to={"/community/create"}className="text-gray-300 hover:text-white transition-colors">Community</Link>
          </div>
           {/* Desktop Auth */}
          <div className="hidden md:flex items-center">
            {user?(
              <div className="flex items-center space-x-4">
                ...
                <button onClick={signOut} className="bg-red-500 px-3 py-1 rounded cursor-grab">Sign Out</button>
              </div>
            ):(
            <button onClick={signInWithGithub} className="bg-blue-500 px-3 py-1 rounded cursor-grab">Sign In With Github</button>
            )}
          </div>
          {/* Mobile Menu Button */}
